...
本系統已確認一般客服採 24×7 日曆時間、Low／Normal／High／Urgent 四級期限、WaitingForCustomer 最多暫停 72 小時、WaitingForInternal 不暫停、Resolved 重開重新計算結案期限，以及 80% 提醒／100% 逾時通知主管並置頂。SLA 不自動改變優先級或轉派，且第一版只套用一般客服案件。

精確期限、達成率公式與狀態關係見 [[02-領域需求/04-客服與售後/客服與AI功能]]；此知識點不再引用早期互動批次作為目前規則。
