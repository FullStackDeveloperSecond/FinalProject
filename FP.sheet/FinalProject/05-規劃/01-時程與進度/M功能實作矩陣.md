...
| M-15 營運報表 | ✅ | ✅ | ✅ | ✅ | 🔵 | ✅ | PR #66 已合併七個報表 Query、一般／財務 Policy、CSV／XLSX、A-27 UI、SQL Provider-backed 與 INT-04 對帳證據；已有代表性後台 Playwright 旅程，但未逐一涵蓋七個 Report Key。revision `99412604` 已在 v2 固定 10,000 筆資料完成七報表 30-sample P95，本機 7／7 低於 3 秒；待 DATA-RC-04 的 Security／PR／CI／合併 Gate。 |
