...
| DEC-P249 | `Shipments.Status`／物流狀態只接受既有狀態機的 `Pending`、`Preparing`、`Shipped`、`InTransit`、`PickupReady`、`PickedUp`、`Delivered`、`DeliveryFailed`、`Returned`，合法轉移以 [[03-架構/狀態機設計]] 為唯一來源。 |
