...
public sealed class DemoDataSeeder(DoSelectDbContext dbContext)
{
        ...
        Category[] categories, Product[] products, List<Sku> skus, CancellationToken cancellationToken)
    {
        ...
        {
            ["CPU_SOCKET"] = "AM5",
            ["CPU_GENERATION"] = "RYZEN_7000",
            ["MOTHERBOARD_CHIPSET"] = "X670E",
            ["MEMORY_TYPE"] = "DDR5",
            ["MEMORY_SLOT_COUNT"] = 4m,
            ["MEMORY_MAX_CAPACITY_GB"] = 128m,
            ["MOTHERBOARD_FORM_FACTOR"] = "ATX",
            ["M2_SLOT_COUNT"] = 4m,
            ["SATA_PORT_COUNT"] = 4m,
            ["MOTHERBOARD_CPU_EPS_8PIN_REQUIRED_COUNT"] = 1m,
            ["MEMORY_MODULE_COUNT"] = 1m,
            ["MEMORY_KIT_CAPACITY_GB"] = 16m,
            ["GPU_LENGTH_MM"] = 280m,
            ["GPU_RECOMMENDED_PSU_WATTS"] = 450m,
            ["GPU_PCIE_6_2PIN_REQUIRED_COUNT"] = 1m,
            ["GPU_12VHPWR_REQUIRED_COUNT"] = 0m,
            ["STORAGE_INTERFACE"] = "M2_NVME",
            ["STORAGE_CAPACITY_GB"] = 2048m,
            ["PSU_RATED_WATTS"] = 650m,
            ["PSU_FORM_FACTOR"] = "ATX",
            ["PSU_PCIE_6_2PIN_COUNT"] = 2m,
            ["PSU_12VHPWR_COUNT"] = 1m,
            ["PSU_CPU_EPS_8PIN_COUNT"] = 2m,
            ["CASE_SUPPORTED_MOTHERBOARD_FORM_FACTOR"] = "ATX",
            ["CASE_GPU_MAX_LENGTH_MM"] = 320m,
            ["CASE_COOLER_MAX_HEIGHT_MM"] = 170m,
            ["CASE_SUPPORTED_PSU_FORM_FACTOR"] = "ATX",
            ["COOLER_HEIGHT_MM"] = 150m,
        };
        ...
        var labels = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["MEMORY_TYPE"] = "記憶體類型",
            ["MEMORY_SLOT_COUNT"] = "記憶體插槽數",
            ["MEMORY_MAX_CAPACITY_GB"] = "記憶體容量上限（GB）",
            ["MOTHERBOARD_FORM_FACTOR"] = "主機板尺寸規格",
            ["M2_SLOT_COUNT"] = "M.2 插槽數",
            ["SATA_PORT_COUNT"] = "SATA 連接埠數",
            ["MOTHERBOARD_CPU_EPS_8PIN_REQUIRED_COUNT"] = "處理器 EPS 8-pin 接頭需求數",
            ["MEMORY_MODULE_COUNT"] = "記憶體模組數",
            ["MEMORY_KIT_CAPACITY_GB"] = "記憶體套組容量（GB）",
            ["GPU_LENGTH_MM"] = "顯示卡長度（mm）",
            ["GPU_RECOMMENDED_PSU_WATTS"] = "顯示卡建議電源功率（W）",
            ["GPU_PCIE_6_2PIN_REQUIRED_COUNT"] = "顯示卡 PCIe 6+2-pin 接頭需求數",
            ["GPU_12VHPWR_REQUIRED_COUNT"] = "顯示卡 12VHPWR 接頭需求數",
            ["STORAGE_INTERFACE"] = "儲存介面",
            ["STORAGE_CAPACITY_GB"] = "儲存容量（GB）",
            ["PSU_RATED_WATTS"] = "電源額定功率（W）",
            ["PSU_FORM_FACTOR"] = "電源尺寸規格",
            ["PSU_PCIE_6_2PIN_COUNT"] = "電源 PCIe 6+2-pin 接頭數",
            ["PSU_12VHPWR_COUNT"] = "電源 12VHPWR 接頭數",
            ["PSU_CPU_EPS_8PIN_COUNT"] = "電源 EPS 8-pin 接頭數",
            ["CASE_SUPPORTED_MOTHERBOARD_FORM_FACTOR"] = "機殼支援的主機板尺寸",
            ["CASE_GPU_MAX_LENGTH_MM"] = "機殼顯示卡長度上限（mm）",
            ["CASE_COOLER_MAX_HEIGHT_MM"] = "機殼散熱器高度上限（mm）",
