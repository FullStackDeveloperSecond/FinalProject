...
- 目前已有 AI 客服 Responses 傳輸 Adapter 與 strict 回應 Schema／引用邊界；搜尋專用 SearchIntent Adapter、正式版本化 Prompt、客服前端垂直切片與 live runner 尚未完成，因此仍沒有 live 品質、延遲或成本 baseline。
