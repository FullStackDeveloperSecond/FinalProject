...
- 2026-09-07 PR #142 squash merge 為 `dev@f3c44ae7` 後，v14 的 `SEARCH-CREATOR-013` 三輪聚焦 3／3 自動及人工 Pass、成本 US$0.001764；完整 baseline 66／66、成本 US$0.135933，所有自動門檻 100%，正式人工覆核 66 Pass／0 Fail，最終 `PASS`。證據見 [`results/2026-09-07-v14-support-v7-release-baseline-f3c44ae7.md`](results/2026-09-07-v14-support-v7-release-baseline-f3c44ae7.md)。
- AI 客服 Responses Adapter、M-19 與 M-18 搜尋垂直切片均已合併 `dev`；AI-RC-04 已由 exact-revision CI、Security、focused 與完整 Live baseline 關閉。Dataset v1.0.13、support-v7、grader v1.1.9、模型、timeout、retry 與安全門檻維持；任何相關版本或 runtime 變更都必須重新執行相稱 Gate。
