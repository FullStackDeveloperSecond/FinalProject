/** Taiwan city/county to township/district choices used by home-delivery addresses. */
export const TAIWAN_ADMINISTRATIVE_AREAS = {
...
export type TaiwanCity = keyof typeof TAIWAN_ADMINISTRATIVE_AREAS

export const TAIWAN_CITIES = Object.keys(TAIWAN_ADMINISTRATIVE_AREAS) as TaiwanCity[]

export function districtsForCity(city: string): readonly string[] {
  return TAIWAN_ADMINISTRATIVE_AREAS[city as TaiwanCity] ?? []
}
